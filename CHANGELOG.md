...
## v1.2.0 - Interactive Commands & Components - 2025-11-07

### 🎉 Release v1.2.0 - Interactive Commands & Components
...
- 399 comprehensive tests (89.7% coverage)
...
Complete documentation overhaul with 800+ lines of new content:

- Updated all docs for v1.2.0 features
- Complete API reference for commands, components, and composable
- Real-world examples for Blade and Vue implementations
- CSRF setup instructions for headless wizards


---

**Full Changelog**: https://github.com/invelity/laravel-headless-wizard/compare/v1.1.0...v1.2.0
